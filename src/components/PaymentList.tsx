        ...
        <table className="min-w-full">
          <thead className="bg-gradient-to-r from-slate-50 to-gray-100 border-b border-slate-200">
            <tr>
              ...
              <th scope="col" className="px-2 sm:px-3 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-700 uppercase tracking-wider min-w-[90px] bg-indigo-50">
                Mode
              </th>
              <th scope="col" className="px-2 sm:px-3 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-700 uppercase tracking-wider min-w-[80px] bg-amber-50">
                Status
              </th>
              ...
              <th scope="col" className="px-2 sm:px-3 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-700 uppercase tracking-wider min-w-[100px] bg-rose-50">
                Notes
              </th>
            </tr>
          </thead>
              ...
              >
                <td className="whitespace-nowrap py-3 sm:py-4 pl-3 sm:pl-4 pr-2 sm:pr-3 text-xs sm:text-sm font-medium text-blue-700 bg-blue-50/20">
                  <div className="flex items-center gap-1">
                    <CalendarIcon className="w-3 h-3 sm:w-4 sm:h-4 text-blue-500 flex-shrink-0" />
                ...
                <td className="whitespace-nowrap px-2 sm:px-3 py-3 sm:py-4 text-xs sm:text-sm font-bold bg-green-50/20">
                ...
                <td className="whitespace-nowrap px-2 sm:px-3 py-3 sm:py-4 text-xs sm:text-sm bg-indigo-50/20">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getPaymentModeColor(payment.paymentMode)}`}>
                    <div className="flex items-center gap-1">
                ...
                <td className="whitespace-nowrap px-2 sm:px-3 py-3 sm:py-4 text-xs sm:text-sm bg-amber-50/20">
                  <span className={`px-3 py-1 inline-flex text-xs leading-5 font-medium rounded-full border ${getStatusColor(payment.paymentStatus)}`}>
                ...
                <td className="whitespace-nowrap px-2 sm:px-3 py-3 sm:py-4 text-xs sm:text-sm font-medium text-purple-700 bg-purple-50/20">
                  <div className="max-w-[60px] sm:max-w-none truncate">
                    {payment.referenceNumber ? (
                      <span className="font-mono bg-purple-50 px-2 py-1 rounded text-xs border border-purple-200">
                        {payment.referenceNumber}
                      </span>
                    ) : (
                ...
                <td className="px-2 sm:px-3 py-3 sm:py-4 text-xs sm:text-sm text-rose-700 bg-rose-50/20">
                  <div className="max-w-[80px] sm:max-w-none truncate font-medium">
                    {payment.notes ? (
                      <span className="bg-rose-50 px-2 py-1 rounded text-xs border border-rose-200">
                        {payment.notes}
                      </span>
                    ) : (
                      <span className="text-gray-400">-</span>
          ...
          <tfoot className="bg-gradient-to-r from-emerald-50 to-green-50 border-t-2 border-emerald-200">
            <tr>
              <th scope="row" className="py-4 pl-3 sm:pl-4 pr-2 sm:pr-3 text-left text-sm font-semibold text-emerald-700">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 bg-emerald-500 rounded-full"></span>
                  Total
                </div>
              </th>
              <td className="px-2 sm:px-3 py-4 text-left text-sm font-bold text-emerald-700">
